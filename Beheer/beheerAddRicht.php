...
<div class="main">
    ...
    <div class="beheerEditorTemp">
        <form method="post">
                ...
                <input type="text" name="richtlijn" require><br>
                ...
                <input type="text"  name="extention_text" require><br>
        ...
        <?php
        echo $_POST['extention'];
        if(isset($_POST['save'])){
   
                    $richtlijnQuery = "INSERT INTO `richtlijnen` (`id`, `soort`, `richtlijn`, `extention`, `extention_text`) VALUES (NULL, '{$_POST['soort']}', '{$_POST['richtlijn']}', '{$_POST['extention']}', '{$_POST['extention_text']}')";
