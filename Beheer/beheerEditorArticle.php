...
<div class="main">
    ...
    <div class="beheerEditorTemp">
        <form method="post">
                ...
                <input type="text" name="title"value="<?php echo"{$row['title']}"; ?>" require><br>

                <label for="excerpt">Inleiding:</label><br>
                <input type="text"  name="excerpt" value="<?php echo"{$row['excerpt']}"; ?>" require ><br>

                <label for="tumbnail">Tumbnail:</label><br>
                <input type="text"  name="img" value="<?php echo"{$row['img']}"; ?>" require><br>

                <label for="bron">Bron:</label><br>
                <input type="text" name="bron" value="<?php echo"{$row['bron']}"; ?>" require ><br>

                <label for="bron">Bronnaam:</label><br>
                <input type="text" name="bron_naam" value="<?php echo"{$row['bron_naam']}"; ?>" require ><br>

                <label for="body">Body:</label></br>            
                <textarea name="body" require ><?php echo"{$row['body']}"; ?></textarea> <br>
