...
<div class="main">
    ...
    <div class="beheerEditorTemp">
        <form method="post">
                ...
                <input type="text" name="question" require><br>

                <label for="answer">Antwoord:</label><br>
                <input type="text"  name="answer" require><br>
        ...
        if(isset($_POST['save'])){
            ...
            if(isset($_POST['save'])&&isset($_POST['question'])&&isset($_POST['answer'])){

                if(!empty($_POST['question'])&&!empty($_POST['answer'])){
                    $faqQuery = "INSERT INTO `faq` (`id`, `question`, `answer`)
                                 VALUES (NULL,'{$_POST['question']}','{$_POST['answer']}')";
